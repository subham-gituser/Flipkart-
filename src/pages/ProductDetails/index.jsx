...
import {ShoppingCartIcon,FlashOnIcon, StarIcon,LocalOfferIcon,VerifiedUserIcon,CachedIcon,CurrencyRupeeIcon , FavoriteIcon } from '@mui/icons-material/ShoppingCart';
import {Dialog, DialogActions , DialogTitle} from '@mui/material/Dialog';
...
const ProductDetails = () => {
    ...
    const addToWishlistHandler = () => {
        if (itemInWishlist) {
           ...
           ("Remove From Wishlist", { variant: "success" });
        } else {
            dispatch(addToWishlist(productId));
         ("Added To Wishlist", { variant: "success" });
        }
    }
    ...
    useEffect(() => {
        ...
        if (success) {
           ("Review Submitted Successfully", { variant: "success" });
